...
\vspace*{0em}
  ...
  \end{subfigure}
  \caption{Semantics of \inblue{\ensuremath{\mathsf{ref.is\_null}}} in the Wasm specification}
  \label{fig:spec1}
\end{figure}
...
\inblue{\ensuremath{\mathsf{ref.is\_null}}} instruction in the official Wasm specification.
...
\begin{verbatim}
                        ...
                        rule Step_pure/ref.is_null-false:
                          ...
                          -- otherwise
\end{verbatim}
\caption{Semantics of \inblue{\ensuremath{\mathsf{ref.is\_null}}} in \dslname's DSL}
\label{fig:dsl}
\end{figure}
...
Fig.~\ref{fig:dsl} illustrates the semantics of \inblue{\ensuremath{\mathsf{ref.is\_null}}} in DSL,
...
\dslname's DSL is designed to provide a close and easy representation and reasoning of
