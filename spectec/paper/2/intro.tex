...
To alleviate the challenges faced by Wasm language designers, we introduce \textbf{SpecTec}, a tailored language framework that \textit{mechanizes} the Wasm standardization process. 
