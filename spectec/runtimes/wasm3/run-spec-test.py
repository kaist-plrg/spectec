...
# sys.path.append("/home/suhyeon/wasm3/wasm3/extra/")
...
parser.add_argument("--exec", metavar="<interpreter>", default="./wasm3 --repl")
...
def runInvoke(test):
    ...
    # test_id = f"{test.source} {test.wasm} {test.cmd[0]}({', '.join(map(str, test.cmd[1:]))})"
