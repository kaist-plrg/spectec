...
let al_of_special_vbinop = function
  ...
  | V128 (V128.I8x16 (V128Op.NarrowS)) -> CaseV ("NARROW", [ TupV [ nullary "I8"; numV 16L ]; TupV [ nullary "I16"; numV 8L ]; al_of_extension Types.SX ])
  | V128 (V128.I16x8 (V128Op.NarrowS)) -> CaseV ("NARROW", [ TupV [ nullary "I16"; numV 8L ]; TupV [ nullary "I32"; numV 4L ]; al_of_extension Types.SX ])
  | V128 (V128.I8x16 (V128Op.NarrowU)) -> CaseV ("NARROW", [ TupV [ nullary "I8"; numV 16L ]; TupV [ nullary "I16"; numV 8L ]; al_of_extension Types.ZX ])
  | V128 (V128.I16x8 (V128Op.NarrowU)) -> CaseV ("NARROW", [ TupV [ nullary "I16"; numV 8L]; TupV [ nullary "I32"; numV 4L ]; al_of_extension Types.ZX ])
